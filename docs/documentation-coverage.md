...
| Life of a transaction | Partial | Built from reviewed broadcast, mempool, block, and reorg notes. Wallet transaction creation and P2P paths pending. |
...
| Wallet flow | Partial | First-pass wallet startup/lifecycle, wallet RPC, and backup/import RPC review exists. Detailed spend, coin, and encryption command groups pending. |
...
| `src/wallet/rpc/backup.cpp` | Partial | First-pass backup, restore, legacy import, descriptor import, dump, and rescan-related review exists. Commands untested. |
...
| Area | Status | Notes |
|---|---|---|
| Wallet guide | Partial | First-pass wallet startup, wallet RPC, backup/import, address, and source-observed defaults added. Release verification, platform steps, spend/encryption details pending. |
...
| Repository map | Partial | Refreshed for storage, notification, template, mining RPC, blockchain RPC, wallet startup, and wallet RPC files. Needs backup/import RPC file added after navigation cleanup. |
| Source tree guide | Partial | Refreshed for storage, notification, template, mining RPC, blockchain RPC, wallet startup, and wallet RPC files. Needs backup/import RPC file added after navigation cleanup. |
...
1. Repository map/source tree refresh for wallet backup/import RPC file.
