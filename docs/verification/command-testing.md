...
|---|---|---|
| `bitcoinII-cli getblockchaininfo` | Placeholder | Needs a synced-node or regtest record. |
| `bitcoinII-cli getnetworkinfo` | Placeholder | Network RPC source review is still pending. |
| `bitcoinII-cli getblockcount` | Placeholder | Needs basic node command record. |
| `bitcoinII-cli getbestblockhash` | Placeholder | Needs basic node command record. |
...
| Command | Current status | Notes |
|---|---|---|
| `bitcoinII-cli getwalletinfo` | Placeholder | Needs loaded-wallet test record. |
| `bitcoinII-cli listwallets` | Placeholder | Needs wallet-enabled node record. |
| `bitcoinII-cli listwalletdir` | Placeholder | Needs wallet-directory path notes. |
| `bitcoinII-cli getnewaddress` | Placeholder | Needs temporary-wallet test record. |
...
| Command | Current status | Notes |
|---|---|---|
| `bitcoinII-cli getmininginfo` | Placeholder | Needs node command record. |
| `bitcoinII-cli getblocktemplate '{"rules":["segwit"]}'` | Placeholder | Needs local node record and context. |
...
| `bitcoinII-cli decoderawtransaction <hex>` | Placeholder | Needs harmless fixture. |
| `bitcoinII-cli decodescript <hex>` | Placeholder | Needs harmless fixture. |
...
| Command | Current status | Notes |
|---|---|---|
| `bitcoinII-cli testmempoolaccept '["signedhex"]'` | Placeholder | Good candidate for regtest dry-run testing. |
| `bitcoinII-cli sendrawtransaction <hex>` | Placeholder | Live submission path; test only in regtest or tightly controlled context. |
| `bitcoinII-cli getrawmempool true` | Placeholder | Needs local node record. |
| `bitcoinII-cli getmempoolinfo` | Placeholder | Needs local node record. |
...
**Status:** Draft
**Primary sources checked:** Current MoreBC2 RPC, wallet, node, mining, and configuration pages
