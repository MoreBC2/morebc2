...
The repository has moved beyond a basic wiki framework. It now has a substantial architecture handbook, Source Atlas, RPC review track, wallet review track, exchange framework, ecosystem/API framework, release-verification framework, command-test tracker, smoke-test plan, network release comparison, network test coverage map, network test run plan, verification queue, private-review workflow, and editorial rules.
...
- Release artifact verification model checked against actual releases.
...
- Release source comparison, network release comparison, and artifact checklist exist.
...
| Verification queue | Partial | Major unknowns, release-check work, command-test tracking, command smoke-test plan, network release comparison, network test coverage map, network test run plan, feedback buckets, stale-wording scan tracker, and review handoff now exist. |
...
| Release verification | Partial | Release page observations, source comparison, network comparison, and artifact checklist exist; release files/manifests/signatures are not verified. |
...
1. Start the first one or two narrow private-review assignments.
2. Keep private-review feedback in narrow buckets.
3. Continue release artifact verification when full asset data is available.
...
6. Continue direct ecosystem checks separately from source documentation.

## Verification

**Status:** Draft
**Primary sources checked:** Repository structure, current documentation files, coverage dashboard, private-review readiness checklist, private-review assignments, private-review handoff, contribution guide, legal/reuse posture note, command smoke-test plan, network release comparison, network test coverage map, network test run plan, and root README reviewer flow
